...

{
    ...
    public function game($slug)
    {
        ...
        $args = [ 
                    ...
                    [
                        $user->_id, 
                        'https://jackpot.sh', //exit_url 
                        'https://jackpot.sh', //cash_url
                        '1' //https
                    ], 
                    '1', //denomination
        ...
        $bonustoken = $unique . '-' . $user->_id . '-' . $currency . '-' . $slug;
        $bonusarg = [ 
                    $bonustoken, 
                    $game, 
                    [
