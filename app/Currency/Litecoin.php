...
class Litecoin extends V16RPCBitcoin {
    ...
    public function dailyminslots(): float {
        ...
        return number_format(($dailyslotsbet / \App\Http\Controllers\Api\WalletController::rateDollarLtc()), 7, '.', '');
    }
    ...
    public function emeraldvip(): float {
        ...
        return number_format(($emeraldvip / \App\Http\Controllers\Api\WalletController::rateDollarLtc()), 7, '.', '');
    }
    public function rubyvip(): float {
        $rubyvip = \App\Settings::where('name', 'rubyvip')->first()->value;
        return number_format(($rubyvip / \App\Http\Controllers\Api\WalletController::rateDollarLtc()), 7, '.', '');
    }
    public function goldvip(): float {
        $goldvip = \App\Settings::where('name', 'goldvip')->first()->value;
        return number_format(($goldvip / \App\Http\Controllers\Api\WalletController::rateDollarLtc()), 7, '.', '');
    }
    public function platinumvip(): float {
        $platinumvip = \App\Settings::where('name', 'platinumvip')->first()->value;
        return number_format(($platinumvip / \App\Http\Controllers\Api\WalletController::rateDollarLtc()), 7, '.', '');
    }
    public function diamondvip(): float {
        $diamondvip = \App\Settings::where('name', 'diamondvip')->first()->value;
        return number_format(($diamondvip / \App\Http\Controllers\Api\WalletController::rateDollarLtc()), 7, '.', '');
    }
