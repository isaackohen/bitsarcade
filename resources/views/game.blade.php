...
<div class="container-fluid">
    <div class="game-container mt-2">
        <div class="row">
            ...
            <button class="btn btn-secondary" onclick="redirect('/gamelist')">Games</button> <img src="/img/logo/logo_temp.png" width="32px" height="32px" style="margin-left: 10px; margin-right: 10px;">
        </div>
