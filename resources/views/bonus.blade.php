            ...
            <div class="col-12 col-sm-12 col-md-6">
                <div class="bonus-box-small">
                    ...
                    <div class="text">
                        ...
                        echo date("H\\h  i\\m", $timeLeft); ?></p><div class="btn btn-warning m-1 p-2" onclick="$.vipBonus()">Your Daily Bonus</div>
                    </div></div>
                </div>
                <div class="col-12 col-sm-12 col-md-6">
                    <div class="bonus-box-small">
                    ...
                    <div class="text">
                        ...
                        <p>Contact support if you need help with your deposit.</p> <a class="btn btn-danger m-1 p-2" data-mdb-toggle="collapse" href="#collapseExample" role="button" data-mdb-toggle="animation" data-mdb-animation-reset="true" data-mdb-animation="slide-in" aria-expanded="false" aria-controls="collapseExample">More Info</a>
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        ...
                        <div class="text">
                            ...
                            <p>Our Discord & Telegram bot automatically dispurses promocodes for DOGE coins, every 30 minutes.</p><div class="btn btn-warning m-1 p-2" data-toggle-bonus-sidebar="promo">Enter Promocode</div>
                        </div></div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="bonus-box-small">
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <div class="text">
                                    ...
                                    <p>Simply by playing you automatically work towards your first or next VIP level.</p><div class="btn btn-primary m-1 p-2" onclick="$.vip()">VIP Rewards</div>
                                </div></div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                                <div class="bonus-box-small">
                                ...
                                <div class="text">
                                    ...
                                    <p>Be active and get rewarded by our DOGE Rain Bot, dropping every 10 minutes!</p><div class="btn btn-light m-1 p-2" onclick="redirect('{{ \App\Settings::where('name', 'discord_invite_link')->first()->value }}')">Join Discord</div>
                                </div></div>
                            </div>
                        </div>
                    </div>
