...
@foreach(\App\Games\Kernel\Game::list() as $game)
        ...
        @endforeach
                        ...
                        <div class="text"  style="padding: 10px; background: url(/img/misc/arrows.svg), linear-gradient(#ff7907, #a04625) !important; border-radius: 12px;">
                            <p>Play our own games!</p>
    ...
    <div class="our-games">
        ...
        @endforeach
              ...
              <button class="btn btn-auth p-4" onclick="redirect('/')">check out our provably fair in-house games<br><img src="/img/logo/logo_temp.png" width="65px" height="50px"></button>
            </div>
        </div>
    </div>
    </div>
