  ...
  <div class="games">
    <div class="row mb-3">
      <div class="col-md-3 col-sm-12 mt-1 mb-2 d-none d-sm-block">
        <div class="card text-center" style="min-height: 165px; background: transparent !important;">
          <div class="card-body" style="background: url(/img/misc/arrows.svg) !important; box-shadow: -3px -3px 8px 1px #11141fcf, 2px 2px 8px 0px #0d0d0dcf, inset 1px 1px 0px 0px #1f2330 !important;">
            ...
            <a onclick="$.vip()" class="btn btn-primary p-2 m-1">Loyalty Rewards</a>
            @else
            <a onclick="$.vip()" class="btn btn-primary p-2 m-1">Loyalty Rewards</a>
            <a onclick="redirect('/bonus/')" class="btn btn-primary p-2 m-1">Faucet</a>
            <a onclick="redirect('/bonus/')" class="btn btn-primary p-2 m-1">Bonuses</a>
            <a onclick="redirect('/earn/')" class="btn btn-primary p-2 m-1">Earn Wall</a>
            @endif
            @if(auth()->user()->weekly_bonus_obtained)
            <a onclick="$.vipBonus()" class="btn btn-primary p-2 m-1 disabled">Royalty Claimed</a>
            <a onclick="redirect('/earn/')" class="btn btn-primary p-2 m-1">Earn Wall</a>
            ...
            @endphp
            <a onclick="$.vipBonus()" class="btn btn-primary p-2 m-1">Daily Royalty - {!! __('general.takeindex', ['value' => floatval($bonususd), 'icon' => "fas fa-usd-circle"]) !!}</a>
            @else
            @endif
          </div>
        </div>
      ...
      <div class="col-md-6 col-sm-12 mt-1 mb-2">
        <div class="carousel slide carousel-fade" data-mdb-ride="carousel" data-mdb-interval="1500">
