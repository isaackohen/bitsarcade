...
return [
    ...
    'overview' => [
        'guest_content' => "<p>Advertise and earn crypto by spreading the word about bets.sh!</p>
        ...
        'content' => "<p>Advertise bets.sh and earn tons of crypto!</p>
                      ...
                      <input readonly class='mt-2' style='cursor: pointer !important;' id='link' data-toggle='tooltip' data-placement='top' title='Copy link' value='https://bets.sh/?c=:id'>
