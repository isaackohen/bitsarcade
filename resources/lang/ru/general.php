...
return [
    ...
    'error' => [
		...
		'promo_unusable' => 'Вы не можете использовать этот промокод на новом аккаунте!',
		'promo_wait_to_use' => 'Вам нужно подождать прежде чем использовать этот промокод на новом аккаунте!',
